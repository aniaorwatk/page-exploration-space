...
export const buttonClass = "primary";
...
export const getErrorsEmail = ({ email }: { email?: IErrorContentType }) => {
  return (
    ...
    (email?.type === IErrorType.maxLength &&
      labels.register.warningMaxCharacters)
  );
};
...
export const getErrorsPassword = ({
  ...
  return (
    (password?.type === IErrorType.required &&
    ...
    (password?.type === IErrorType.validate &&
      labels.register.warningDifferentName)
  );
};
