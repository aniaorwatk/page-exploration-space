...
import { buttonClass, buttonType, eyeOffPassword, eyeOnPassword, formInputsType, getErrorLogin, getErrorsPassword, InputType, nameInputs } from "../Register/RegisterHandler";
import './Login.scss';
...
const Login =()=>{
    ...
    const {
      ...
      const onSubmit: SubmitHandler<ILoginFormType> = (data) =>
    console.log(data);
